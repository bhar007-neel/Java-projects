...
public class Course {
     ...
     */
    public TeachingAssistant getTeachingAssistant(){return assistant;}
    ...
    /**
       Sets the Teaching Assignment the course
        @param assistant the assistant to set
     */

    public void setTeachingAssistant(TeachingAssistant assistant){this.assistant=assistant;}
     ...
     *
     * @return the TA full name or "Not yet assigned" if no TA is set
     */

    private String getTeachingAssistantName(){
        return assistant != null ? assistant.getFirstName() + " " + assistant.getLastName(): "Not yet assigned";
    }
    ...
    public String toString() {
        return "Course information:\n"
                ...
                + "\t course TeachingAssistant" + getTeachingAssistantName() +"\n"
